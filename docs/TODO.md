...
- [ ] Kiosk servisine `UPDATE_REPO=ahmtyldr/LIVI` ekle (`livi-kiosk.service.d/pi3.conf`), cihaz güncellemeleri bu depodan arasın.
- [ ] `pi3-8.3.0` yayınını "ön sürüm" olarak işaretle, "latest" olarak sunulmasın.
- [ ] Cihazdaki nightly AppImage'ı `v9.0.0-livilite.1` gibi bir yayın olarak koy; cihaz kendini güncel görsün.
